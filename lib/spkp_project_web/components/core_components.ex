defmodule SpkpProjectWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: SpkpProjectWeb.Gettext
  ...
  def simple_form(assigns) do
    ...
    <.form :let={f} for={@for} as={@as} {@rest}>
      <div class="mt-2 space-y-2 bg-white">
        ...
        <div :for={action <- @actions} class="mt-10 flex items-center justify-between">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SpkpProjectWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SpkpProjectWeb.Gettext, "errors", msg, opts)
    end
  end
