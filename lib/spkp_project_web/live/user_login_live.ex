        ...
        <form action={~p"/users/log_in"} method="post" id="login_form">
          ...
          <div class="mt-4">
            ...
            <input
              ...
              class="mt-1 w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              required
            />
          </div>
          <!-- Kata Laluan -->
          <div class="mt-4 relative">
            ...
            <input
              ...
              class="mt-1 w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent pr-10"
              required
            />
          </div>
          <!-- Button -->
