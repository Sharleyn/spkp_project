        ...
        <main>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            <div class="bg-sky-50 p-6 rounded-3xl shadow-lg">
              ...
              <p class="text-gray-600 text-center font-medium px-10 mb-4">
                Lengkapkan Profil Untuk Permohonan Yang Lebih Baik
              </p>

              <div class="flex mt-10 justify-center">
                <.link
                  navigate={~p"/userprofile"}
                  class="inline-flex items-center bg-blue-700 bg-opacity-80 text-white px-12 py-2 rounded-full font-medium hover:bg-[#43C6DB] transition-colors duration-200"
                >
              ...
              <div class="space-y-4">
                <%= for app <- @recent_applications do %>
                  <div class="flex items-center justify-between p-4 bg-[#C8C4DF] bg-opacity-50 rounded-2xl">
                    ...
                    <span class={"text-xs font-semibold px-2 py-1 rounded-full #{app.status_class}"}>
                      {app.status}
                    </span>
                  </div>
                <% end %>
          ...
          <div class="bg-indigo-50 p-6 rounded-3xl shadow-lg">
            <h4 class="flex items-center text-lg font-bold mb-4 gap-4 text-gray-700">
              <img src={~p"/images/book.png"} alt="Book Icon" class="w-10 h-10" /> Kursus Tersedia
            </h4>
            ...
            <div class="space-y-4">
              <%= for course <- @available_courses do %>
                <div class="flex items-center justify-between p-4 bg-white rounded-2xl">
                  ...
                  <a
                    href="#"
                    class="bg-blue-600 text-white text-sm font-semibold px-4 py-2 rounded-full hover:bg-blue-700 transition-colors duration-200"
                  >
                    MOHON
                  </a>
                </div>
